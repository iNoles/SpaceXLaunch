...
class LaunchesRvAdapter : RecyclerView.Adapter<LaunchesRvAdapter.LaunchViewHolder>() {

    var launches = emptyList<RocketLaunch>()
    ...
    inner class LaunchViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindData(launch: RocketLaunch) {
            ...
            missionNameTextView.text = ctx.getString(R.string.mission_name_field, launch.name)
            missionDetailsTextView.text = ctx.getString(R.string.details_field, launch.details ?: "")
            val launchSuccess = launch.success
